...
const weapons: WeaponDefinition[] = [
  // ───────────── 剑系 ─────────────
  {
    ...
    description: "江湖制式佩剑，轻快顺手，是剑术入门之选。",
  ...
  {
    id: "qinggang-sword", series: "sword", name: "青釭剑", glyph: "剑",
    description: "剑锋青芒隐现，削铁如泥。",
    attackType: "melee", rarity: "rare", status: "available",
    stats: { damage: 9, attackSpeed: 720, range: 46, critRate: 0.1 },
  },
  {
    id: "longquan-sword", series: "sword", name: "龙泉剑", glyph: "剑",
    description: "江南名匠所铸，剑身温润而锋利。",
    attackType: "melee", rarity: "rare", status: "available",
  ...
  {
    id: "yanyang-blade", series: "blade", name: "雁翎金刀", glyph: "刀",
    description: "金线缠柄，刀风猎猎如雁翅。",
    attackType: "melee", rarity: "legendary", status: "available",
    stats: { damage: 22, attackSpeed: 1000, range: 76, critRate: 0.12 },
  },
  {
    id: "dajiangjun-blade", series: "blade", name: "大将军刀", glyph: "刀",
    description: "军中大将佩刀，威压四方。",
    attackType: "melee", rarity: "legendary", status: "available",
  ...
  {
    id: "pojun-spear", series: "spear", name: "破军枪", glyph: "枪",
    description: "军中破敌之枪，枪刺可破军阵。",
    attackType: "melee", rarity: "legendary", status: "available",
    stats: { damage: 19, attackSpeed: 850, range: 66, critRate: 0.14 },
    tags: ["破甲"],
  },
  {
    id: "huzhang-spear", series: "spear", name: "虎贲枪", glyph: "枪",
    description: "虎贲禁卫所佩，枪势雄浑。",
    attackType: "melee", rarity: "legendary", status: "available",
    stats: { damage: 21, attackSpeed: 920, range: 68, critRate: 0.1, critDamage: 2 },
  },
  {
    id: "bawang-spear", series: "spear", name: "霸王枪", glyph: "枪",
    description: "霸王之枪，一往无前。",
    attackType: "melee", rarity: "mythic", status: "locked",
    stats: { damage: 28, attackSpeed: 900, range: 76, critRate: 0.2, critDamage: 2.4 },
    tags: ["霸体"],
  },
  {
    id: "shenlong-spear", series: "spear", name: "神龙枪", glyph: "枪",
    description: "枪脊如龙脊，一击可破万骑。",
    attackType: "melee", rarity: "mythic", status: "locked",
    stats: { damage: 27, attackSpeed: 880, range: 74, critRate: 0.22 },
    tags: ["龙威"],
  },
  {
    id: "xuechan-spear", series: "spear", name: "血斩枪", glyph: "枪",
    description: "饮血之枪，伤敌越多，杀气越盛。",
    attackType: "melee", rarity: "mythic", status: "locked",
    stats: { damage: 30, attackSpeed: 1000, range: 72, critRate: 0.16, critDamage: 2.6 },
    tags: ["吸血"],
  },
  {
    id: "lietian-spear", series: "spear", name: "裂天枪", glyph: "枪",
    description: "枪势裂天，连人带阵一并贯穿。",
    attackType: "melee", rarity: "mythic", status: "available",
