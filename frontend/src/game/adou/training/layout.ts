...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { key: "achievements", label: "成就",    icon: "Award",    enabled: true,  subtitle: "解锁领取金币奖励" },
  { key: "armory",    label: "军械库",     icon: "Boxes",    enabled: true,  subtitle: "兵器谱与装备" },
  { key: "shop",      label: "商店",       icon: "Shop",     enabled: true,  subtitle: "资源与兵器购买" },
